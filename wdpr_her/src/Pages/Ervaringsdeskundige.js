...
export const Ervaringsdeskundige = () => {
    ...
    const getOnderzoeken = () => {
        axios.get(apiPath + "Onderzoek/GetAllOnderzoeken").then(response => {
                        ...
                        <ul>
                            {onderzoeken.map(onderzoek => (
                                <li key={onderzoek.onderzoekId}>
                                    <h4>{onderzoek.titel} - {onderzoek.uitvoerderNaam}</h4>
                                    <p>Beloning: {onderzoek.beloning}</p>
                                    <Link to={`/ErvaringsdeskundigeOnderzoek/${onderzoek.onderzoekId}`}><button>Meer informatie</button></Link>
                                </li>
                             ))}
                        </ul>
                    </div>
